...
/* Private defines -----------------------------------------------------------*/
#define CLCD_3_Pin GPIO_PIN_2
#define CLCD_3_GPIO_Port GPIOE
#define BUTTON_1_Pin GPIO_PIN_3
#define BUTTON_1_GPIO_Port GPIOE
#define BUTTON_1_EXTI_IRQn EXTI3_IRQn
#define CLCD_3E4_Pin GPIO_PIN_4
#define CLCD_3E4_GPIO_Port GPIOE
#define CLCD_4_Pin GPIO_PIN_5
#define CLCD_4_GPIO_Port GPIOE
#define CLCD_5_Pin GPIO_PIN_6
#define CLCD_5_GPIO_Port GPIOE
...
#define CLCD_6_Pin GPIO_PIN_7
#define CLCD_6_GPIO_Port GPIOE
...
#define CLCD_1_Pin GPIO_PIN_0
#define CLCD_1_GPIO_Port GPIOE
#define CLCD_2_Pin GPIO_PIN_1
#define CLCD_2_GPIO_Port GPIOE
