...
#define LED_RIGHT_BLUE_Pin GPIO_PIN_0
#define LED_RIGHT_BLUE_GPIO_Port GPIOB
#define BUTTON_4_Pin GPIO_PIN_10
#define BUTTON_4_GPIO_Port GPIOD
#define LED_LEFT_RED_Pin GPIO_PIN_12
#define LED_LEFT_RED_GPIO_Port GPIOD
#define LED_LEFT_GREEN_Pin GPIO_PIN_13
#define LED_LEFT_GREEN_GPIO_Port GPIOD
#define LED_LEFT_BLUE_Pin GPIO_PIN_14
#define LED_LEFT_BLUE_GPIO_Port GPIOD
...
#define LED_RIGHT_GREEN_Pin GPIO_PIN_5
